...
/**
 * Test case for class Tx_Clubmanagement_Controller_ReportController.
 *
 * @version $Id$
 ...
 */
class Tx_Clubmanagement_Controller_ReportControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
