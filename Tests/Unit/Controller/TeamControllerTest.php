...
/**
 * Test case for class Tx_Clubmanagement_Controller_TeamController.
 *
 * @version $Id$
 ...
 */
class Tx_Clubmanagement_Controller_TeamControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
