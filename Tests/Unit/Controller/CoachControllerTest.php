...
/**
 * Test case for class Tx_Clubmanagement_Controller_CoachController.
 *
 * @version $Id$
 ...
 */
class Tx_Clubmanagement_Controller_CoachControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
