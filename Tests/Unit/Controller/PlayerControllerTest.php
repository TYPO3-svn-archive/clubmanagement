...
/**
 * Test case for class Tx_Clubmanagement_Controller_PlayerController.
 *
 * @version $Id$
 ...
 */
class Tx_Clubmanagement_Controller_PlayerControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
